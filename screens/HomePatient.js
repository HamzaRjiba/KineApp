...
const HomePatient = () => {
  ...
  const handleDocument= () => {
    navigation.navigate('DocumentsPatient');
  ...
  const advantagesData = [
    {
      ...
      text: 'Accédez rapidement aux disponibilités de tous vos  kinésithérapeutes'
    },
    {
      image: require('../assets/advantage2.png'),
      text: 'Économisez du temps et Gérez facilement en ligne vos rendez-vous et documents de santé'
    },
    {
      image: require('../assets/advantage3.png'),
      text: 'Profitez d\'un suivi personnalisé avec nos kinésithérapeutes professionnels'
    }
  ];
  ...
  return (
    <PaperProvider>
      <View style={styles.appBar}>
        ...
        >
         <Menu.Item onPress={() => {}} title="Compte" />
          <Divider />
          <Menu.Item onPress={handleDocument} title="Mes documents" />
        </Menu>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <Text style={styles.heading}>Trouvez un rendez-vous avec</Text>
        <Text style={styles.heading2}>une kinésithérapeute</Text>

        <TouchableOpacity style={styles.searchButton} onPress={handleButtonSearch}>
          <Icon name="search" size={24} color="#e61c28" />
