...
const NavBarPatient = () => {
  ...
  const handleButtonPress = () => {
    navigation.navigate('HomePatient'); // Naviguez vers l'interface "rdv" en utilisant son nom dans la navigation
  };
  const handleButtonRdv= () => {
    navigation.navigate('RendezVousPatient'); // Naviguez vers l'interface "rdv" en utilisant son nom dans la navigation

  };

  const handleButtonProg= () => {
    navigation.navigate('ProgramPatient'); // Naviguez vers l'interface "rdv" en utilisant son nom dans la navigation
    
  };
  
  const handleButtonPaiement= () => {
    navigation.navigate('PaiementPatient'); // Naviguez vers l'interface "rdv" en utilisant son nom dans la navigation
